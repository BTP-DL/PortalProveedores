sap.ui.define([
	...
	"simplot/portalsqas/utils/controller/CommonOC",
	"simplot/portalsqas/utils/controller/CommonAltaForm",
	"simplot/portalsqas/utils/controller/CommonClaims",
	"simplot/portalsqas/utils/controller/CommonFacturas",
    "simplot/portalsqas/utils/controller/CommonFacturasView",
	"simplot/portalsqas/utils/controller/CommonCtaCte"
	//helpers
	...
	return {
		...
		onShowBusy: function () {
			...
			if (!oController._dialog) {
				oController._dialog = sap.ui.xmlfragment("simplot.portalsqas.view.fragment.BusyStatus", oController);
