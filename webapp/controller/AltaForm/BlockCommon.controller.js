sap.ui.define([
	...
	var modelsHelp = sap.ui.require("simplot/portalsqas/utils/models");
	var gatewayHelp = sap.ui.require("simplot/portalsqas/utils/gateway");
	var fileDownloadHelp = sap.ui.require("simplot/portalsqas/utils/FileDownHelp");
	var commonHelp = sap.ui.require("simplot/portalsqas/utils/Common");
	var commonHelpAuto = sap.ui.require("simplot/portalsqas/utils/controller/CommonAltaForm");
	jQuery.sap.declare({ modName: "simplot.portalsqas.controller.AltaForm.BlockCommon", "type": "controller" });

	sap.ui.core.mvc.Controller.extend("simplot.portalsqas.controller.AltaForm.BlockCommon", {
		...
		onPressUpFile: function (oEvent) {
			...
			if (!this._ControllerSendFile) {
				this._ControllerSendFile = {
					...
					"onFileUpload": function (oEvent) {
						var fileReaderHelp = sap.ui.require("simplot/portalsqas/utils/FileReaderHelp");
			...
			if (!this._DialogSendFile) {
				this._DialogSendFile = sap.ui.xmlfragment("simplot.portalsqas.view.fragment.SendFile", this._ControllerSendFile);
